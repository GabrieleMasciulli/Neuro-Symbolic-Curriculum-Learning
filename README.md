...
This repository extends the [RSBench](https://github.com/ema-marconato/rsbench) codebase with data-centric strategies—**Curriculum Learning** and **Active Learning**—to mitigate **Reasoning Shortcuts (RSs)** in Neuro-Symbolic (NeSy) architectures trained via weak supervision. Experiments are conducted on MNIST-Half, Shortcut-MNIST, and BDD-OIA.
